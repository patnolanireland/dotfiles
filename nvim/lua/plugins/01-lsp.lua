	...
	-- LSP Configuration
	{
		...
		config = function()
			...
			mason_lspconfig.setup({
				-- This list ensures these servers are installed
				ensure_installed = {
					'lua_ls',
					'ts_ls',
					'omnisharp',
				...
				-- This 'handlers' table uses the new vim.lsp.config API
				handlers = {
					-- Default handler for all servers
					function(server_name)
						-- This is the new, non-deprecated way
						vim.lsp.config(server_name, {
							capabilities = capabilities,
						})
					end,

					-- ⭐ Do NOT set up rust_analyzer.
